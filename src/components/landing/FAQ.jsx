...
export default function FAQ() {
  ...
  return (
    <section
      id="faq"
      className="py-24 lg:py-32 border-t border-white/5 bg-[#0b0b0d]"
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-[360px_1fr] gap-16">
          ...
          >
            ...
            <p className="text-sm text-white/30 font-body mt-6 leading-relaxed">
              {f.subtext}
            </p>

            <a
              href="#kontakt"
              className={`inline-flex items-center gap-2 mt-6 text-sm font-heading font-bold transition-colors ${
                isMobile
                  ? 'text-[#24a1db]'
                  : 'text-[#24a1db] hover:text-white group'
              }`}
            >
              {f.contactLink}
          ...
          <div className="space-y-0 border-t border-white/8">
            {faqs.map((faq, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={isMobile ? {} : { delay: i * 0.04 }}
              ...
              >
                ...
                >
                  <div className="flex items-center gap-5">
                    <span className="text-xs font-body font-bold text-white/20">
                      {faq.num}
                    </span>
