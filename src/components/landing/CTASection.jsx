      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-[420px_1fr] gap-16 lg:gap-20 items-start">
          ...
          >
            ...
            <p className="text-sm text-white/40 font-body leading-relaxed mb-10 max-w-sm">
              {c.subtext}
            </p>
              ...
              >
                <div
                  className={`w-10 h-10 rounded-sm border border-white/10 flex items-center justify-center ${
                    !isMobile
                      ? 'text-white/30 group-hover:border-[#24a1db] group-hover:text-[#24a1db] transition-all'
                      : 'text-white/30'
                  }`}
                >
                ...
                <div>
                  <div className="text-[10px] font-body tracking-[0.2em] text-white/20 uppercase">
                    EMAIL
                  </div>
                  <div
        ...
        href="https://www.instagram.com/leofudaly/"
          target="_blank"
            ...
            <div className="flex items-center gap-2 mt-10">
              <div
                className={`w-2 h-2 rounded-full bg-[#24a1db] ${
          ...
          <motion.div
            ...
            whileInView={!isMobile ? { opacity: 1, y: 0 } : undefined}
            viewport={!isMobile ? { once: true } : undefined}
            transition={!isMobile ? { delay: 0.15 } : undefined}
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="text-[10px] font-body tracking-[0.15em] text-white/30 uppercase block mb-2">
                      {f.name}
                    </label>
                    <input
                      type="text"
                ...
                <motion.button
                  ...
                  type="submit"
                  className={`w-full flex items-center justify-center gap-3 py-4 bg-[#24a1db] text-black font-heading font-black text-sm tracking-widest rounded-sm ${
                    !isMobile
                      ? 'hover:bg-[#1e8fc4] transition-all duration-200'
                      : ''
                  }`}
                >
                  {f.submit}
