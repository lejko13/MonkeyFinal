          ...
          >
            <div className="flex flex-wrap gap-2 mb-6">
              {project.tags.map((tag) => (
                <span
                  key={tag}
                  className="text-[10px] font-body font-medium px-2.5 py-1 bg-white/5 text-white/40 rounded-sm border border-white/8 tracking-widest"
                >
                  {tag}
                </span>
              ))}
              ...
              {project.process.split(" → ").map((step, i) => (
                <div key={i} className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-sm bg-[#24a1db]/10 border border-[#24a1db]/20 flex items-center justify-center flex-shrink-0">
                    <span className="text-[9px] font-body font-bold text-[#24a1db]">
          ...
          <div className="bg-[#0e0f11] p-8">
            ...
            <div className="flex flex-wrap gap-2">
              {project.tech.map((t) => (
                <span
                  key={t}
                  className="text-xs font-body font-medium px-3 py-1.5 bg-white/5 text-white/50 rounded-sm border border-white/8"
                >
                  {t}
                </span>
              ))}
